...
export const TRACKS = [
  ...
  { roadScale: 1, cornerRadius: 0, name: 'Coastal sweep', kind: 'MEDIUM', description: 'Flowing curves, a sweeping bay and a long return straight.', ground: '#426d7b', edge: '#7da8a1', points: [[0,42],[-38,42],[-65,25],[-72,-8],[-55,-38],[-25,-48],[-5,-24],[15,-18],[38,-42],[68,-25],[72,8],[50,35],[22,42]] },
  { roadScale: .85, cornerRadius: 7.5, name: 'Slate canyon', kind: 'HARD', description: 'Angular bends, a deep canyon detour and a fast outer loop.', ground: '#606478', edge: '#8a92a0', points: [[0,50],[-70,50],[-70,-45],[-30,-45],[-30,12],[0,12],[0,-45],[65,-45],[65,-15],[35,-15],[35,15],[65,15],[65,50]] },
] as const;
